...
var app = new Vue({
    ...
    methods: {
        ...
        do_save: function() {
            ...
            if (that.form.ToDateDesc == '' || that.form.ToDateDesc == null) {
                ns.toast('预计归还日期不能为空');
                return;
            }
        ...
        do_select_date: function(type) {
            ...
            var currentDate = '';
            if (type == 1) {
                currentDate = that.form.FromDateDesc;
            } else {
                currentDate = that.form.ToDateDesc;
            }
            api.openPicker({
                type: 'date',
                date: currentDate,
                ...
                if (ret) {
                    ...
                    if (type == 1) {
                        that.form.FromDateDesc = currentDate;
                    } else {
                        that.form.ToDateDesc = currentDate;
                    }
                }
            });
        },
