...
var app = new Vue({
    ...
    methods: {
        ...
        do_search: function() {
            var that = this;
            var name = 'chuzhisearchbar_frm';
            var url = 'chuzhisearchbar_frm.html';
            var x = 0;
        ...
        do_add_chuzhi: function(id) {
            var title = id > 0 ? '处置单' : '新增处置单';
            var name = 'chuzhiedit_frm';
...
apiready = function() {
    ...
    app.form.OrderTypeID = ns.getPageParam('OrderTypeID') || 100;
